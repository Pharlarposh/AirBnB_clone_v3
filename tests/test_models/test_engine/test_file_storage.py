...
class TestFileStorage(unittest.TestCase):
    ...
    def test_new(self):
        ...
        new_obj = City(name="San Francisco")
        models.storage.new(new_obj)
        self.assertIn("City." + new_obj.id, models.storage.all(type(new_obj)))
    ...
    def test_save(self):
        ...
        models.storage.new(new_obj)
        models.storage.save()
        self.assertIn("State." + new_obj.id, models.storage.all(type(new_obj)))
